            ...
            <div className='col-span-2 lg:col-span-1'>
                <div className='grid grid-cols-2 gap-6'>
                    ...
                    <div className='col-span-2 md:col-span-1 flex lg:justify-end '>
                        <Button variant={"outline"} className=" h-11 px-8 font-roboto text-lg font-medium text-blackDark mr-4">Client</Button>
                        <Button  className='h-11 px-10 font-roboto bg-blue-600 hover:bg-blue-600 text-lg font-medium '>Influencer</Button>
